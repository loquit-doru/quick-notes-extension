---
title: My paywall was eating people's notes
published: true
tags: webdev, javascript, testing, showdev
---
...
Not "stopped writing the extra characters" — stopped writing. The `return` sits
...
I'd built a mechanism that punished exactly the people who had used the product
enough to consider paying for it.

## The part that actually stings

I have an end-to-end test suite. 25 tests, all green — popup flows, note
creation, reminders, folders. It never caught this.
...
None of this showed up as an error. Nothing threw. No console warning, no crash
report, no support email. `return` is a perfectly valid statement.
...
been chasing a crash, or reading analytics, or waiting for someone to complain,
